<?
$MESS ['confirmed_desc'] = "Для получения рассылки необходимо подтвердить свой email-адрес используя форму выше.";
$MESS ['active_desc'] = "После проверки админитратором Ваша подписка будет активирована.";
