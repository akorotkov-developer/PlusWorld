...
<?if($arResult["ALLOW_ANONYMOUS"]=="Y" && $_REQUEST["authorize"]<>"YES" && $_REQUEST["register"]<>"YES"):?>
	...
	<thead><tr><td ><h1><?echo GetMessage("subscr_title_auth2")?></h1></td></tr></thead>
	<tr valign="top">
        <td>
			<p><?echo GetMessage("adm_auth1")?> <a href="/personal/login/"><?echo GetMessage("adm_auth2")?></a>.
			<?if($arResult["ALLOW_REGISTER"]=="Y"):?>
				<br /><?echo GetMessage("adm_reg1")?> <a href="/personal/register/"><?echo GetMessage("adm_reg2")?></a>.
			<?endif;?></p>
		<p class="desc"><?echo GetMessage("adm_reg_text")?></p></td>
	</tr>
	</table>
	<br />
