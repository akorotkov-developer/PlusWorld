...
<div class="news-detail">
    ...
    <div class="news-detail-links">
        ...
        <a href="#comments">Комментировать &darr;</a> &nbsp;
        <br /><br />
    ...
    <div class="news-detail-navig">
        <a href="#prev" class="prev">&larr;&nbsp;Предыдущая новость</a>
        <a href="#next" class="next">Следующая новость&nbsp;&rarr;</a>
        <a href="../">В рубрику &uarr;</a>
    </div>
</div>
