...
?>
    <div class="subscription-field">
        ...
        <label class="subscription-field__label" for="name">Ф.И.О Получателя<span class="text-primary">*</span></label>
    </div>
    <div class="subscription-field subscription-field_helping">
        <input placeholder="Компания" class="subscription-field__input" name="form_text_3" id="company" type="text" value="<?if ($_REQUEST["form_text_3"]) echo $_REQUEST["form_text_3"]?>">
        <label class="subscription-field__label" for="company">Компания</label><span class="subscription-field__helptext">Указать при оформлении корпоративной подписки</span>
    </div>
    <div class="subscription-field">
        ...
        <label class="subscription-field__label" for="phone">Телефон<span class="text-primary">*</span></label>
    </div>
    <div class="subscription-field">
    ...
    <div class="subscription-field">
        ...
        <label class="subscription-field__label" for="comments">Ваши комментарии</label>
    </div>

    <input class="subscription-form__checkbox"  type="checkbox" id="4053" name="form_checkbox_personal_data[]" value="4053">
