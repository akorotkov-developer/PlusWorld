...
<?if ($arResult["isFormNote"] != "Y")
{
    ...
    <div class="page-newsletter__title"><span class="page-newsletter__count">8500</span>подписчиков новостей получили этот материал</div>
    ...
    foreach ($arResult["QUESTIONS"] as $FIELD_SID => $arQuestion)
    {
        ...
        else
        {
            ...
            if ($arQuestion['STRUCTURE'][0]['FIELD_TYPE'] == "email") {?>
                <input class="page-newsletter__input" type="email" name="form_email_4060" placeholder="Подпишитесь, на новостную рассылку">
                <?
            } else echo $arQuestion["HTML_CODE"];
            ?>
            <button class="page-newsletter__submit" type="submit"><i class="fas fa-arrow-right fa-lg"></i></button>
            <?
        }
    } //endwhile
    ?>
