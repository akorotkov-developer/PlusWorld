...
$MESS["REGISTER_FIELD_WORK_DEPARTMENT"] = "Департамент";
$MESS["REGISTER_FIELD_WORK_POSITION"] = "Должность";
$MESS["REGISTER_FIELD_WORK_WWW"] = "Web-site компании";
...
$MESS["MAIN_REGISTER_AUTH"] = "Поздравляем! Вы успешно зарегистрированы на сайте.";
$MESS["MAIN_REGISTER_AUTH_2"] = "Спасибо за интерес к нашим информационным продуктам! Ваша заявка направлена на модерацию администратору сайта. В случае корректного заполнения Анкеты Вам будет направлено автоматическое письмо для подтверждения авторизации.";
