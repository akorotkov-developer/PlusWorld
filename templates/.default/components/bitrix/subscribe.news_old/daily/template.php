...
?>	<tr>
	...
	<tr>
		...
		<td style="vertical-align: top;">
			<?if($arItem["PREVIEW_PICTURE"]):?>
			<a href="<?echo $arItem["DETAIL_PAGE_URL"]?>"><img style="border: none;" align='left' border='0' src="<?echo $sImagePath?>" width="<?echo $width?>" height="<?echo $height?>" alt="<?echo $arItem["PREVIEW_PICTURE"]["ALT"]?>"  title="<?echo $arItem["NAME"]?>"></a>
			<?endif;?>
		</td>
		<td width="10">&nbsp;</td>
		<td style="vertical-align: top;">
