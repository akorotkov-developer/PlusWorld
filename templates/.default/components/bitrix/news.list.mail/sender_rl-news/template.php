...
?>
<div style="background-color: #e4ecee; padding: 15px 0;">
                            ...
                            <tr>
                                ...
                                <td width="250px;" style="vertical-align: bottom; width: 250px; font-family: Arial, Helvetica, sans-serif !important;">
                                    ...
                                    <div>
                                        ...
                                        <span style="font: 12px Arial, sans-serif;">С.Зайцев, К. Мартынова</span>
                                    </div>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table width="618" align="center" border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse; width: 618px;">
                            <tr>
                                <td style="width: 306px; text-align: center; vertical-align: top; font-family: Arial, Helvetica, sans-serif !important;">
                                    <a style="color: #000; font-size: 14px; text-decoration: none; border: none;" href="http://www.plus-forum.com/forum_2018/apr/<?=$labelUrl?>">
                                        <img style="border: none; height: 80px; width: auto;" src="http://www.retail-loyalty.org/images/sub-daily/apr.jpg">
                                        <br />
                                        <span style="text-decoration: none; font: 14px Arial, sans-serif;">&laquo;Online & Offline Retail&raquo;</span>
                                    </a>
                                </td>
                                <td style="width: 306px; text-align: center; vertical-align: top; font-family: Arial, Helvetica, sans-serif !important;">
                                    <a style="color: #000; font-size: 14px; text-decoration: none; border: none;" href="http://www.plus-forum.com/forum_2018/may/<?=$labelUrl?>">
                                        <img style="border: none; height: 80px; width: auto;" src="http://www.retail-loyalty.org/images/sub-daily/may.jpg">
                                        <br />
                                        <span style="text-decoration: none; font: 14px Arial, sans-serif;">&laquo;Дистанционные сервисы, мобильные решения, карты и платежи&raquo;</span>
                                    </a>
                                </td>
                                <td style="width: 306px; text-align: center; vertical-align: top; font-family: Arial, Helvetica, sans-serif !important;">
                ...
                <tr>
                    <td style="padding-top: 20px;">
                        <table width="620" align="center" border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse; width: 620px;">
                            ...
                            <tr>
                                <td style="padding-top: 20px; font-family: Arial, Helvetica, sans-serif !important;">
                                    <div style="color: #fff; margin-bottom: 10px; font: 10px Arial, sans-serif;">Вы получили это письмо, так как дали свое согласие на получение новостей проекта. Если вы больше не хотите получать рассылку, <a style="text-decoration: underline; text-decoration-color:#fff; color: #fff;" href="http://www.retail-loyalty.org/personal/subscribe/">нажмите сюда</a></div>
                                </td>
                            </tr>
                        </table>
                    </td>
