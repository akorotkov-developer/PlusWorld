...
<?if ($_REQUEST["r"] == 1) {?>
<?/*echo $arParams["~UNIQUE_COMPONENT_ID"];?><br />
<?echo $arResult["NAV_RESULT_NavPageNomer"];?><br />
<?echo $arResult["NAV_RESULT_NavPageSize"];?><br />
<?echo $_REQUEST['get_elements_html'];?><br />
<?echo "<pre>"; print_r ($arResult); echo "</pre>";*/?>
<div id="photo-more-photo-link-cont" class="photo-show-more">


	<img class="show-more-wait" src="/bitrix/components/bitrix/photogallery.detail.list.ex/templates/.default/images/wait.gif" />
	<a id="photo-more-photo-link" href="javascript:void(0);" title="<?=GetMessage("P_SLIDER_15_PHOTOS")?>"><?= GetMessage("P_SLIDER_15_PHOTOS")?></a>
	<a id="photo-more-photo-link" href="javascript:void(0);" title="<?= GetMessage("P_SLIDER_30_PHOTOS")?>"><?= GetMessage("P_SLIDER_30_PHOTOS")?></a>
</div>
<? } ?>
