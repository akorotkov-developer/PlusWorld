...
<?$ar_result=CIBlockSection::GetList(Array("SORT"=>"DESC"), Array("IBLOCK_ID"=>"67", "ID"=>$arResult["VARIABLES"]["SECTION_ID"]),false, Array("UF_CLOSE_GALLERY"));
...
<?$APPLICATION->IncludeComponent("cetera:news.list", "video", Array(
	...
	elseif ($res["UF_CLOSE_GALLERY"] == "1")  
		{?>
		<p>Видео данного раздела доступно только авторизованным Пользователям информационного портала корректно заполнившим при регистрации следующие Поля анкеты: </p>
		<ul>
			<li>Фамилия </li>
			<li>Имя </li>
			<li>Корпоративный e-mail </li>
			<li>Название компании </li>
			<li>Должность </li>
		</ul>
		Личном кабинете
Или пройти Регистрацию
		<p>Если Вы видите это сообщение, то Вам следует <a style="color: blue;" href="/auth/" alt="Авторизация" title="Авторизация" target="_blank" >Авторизоваться</a>, скорректировать данные в <a style="color: blue;" href="/personal/" alt="Личный кабинет" title="Личный кабинет" target="_blank" >Личном кабинете</a></p>
		<p>Или пройти <a style="color: blue;" href="/personal/register/" alt="Регистрация" title="Регистрация" target="_blank" >Регистрацию</a> </p>
		<p>Если Вы предоставили корректную информацию, после проверки Администратором портала Вам будет предоставлен доступ к закрытым Видеогалереям! </p>
		<p>С уважением, <br />
		Администрация информационного портала PLUSworld.ru </p>
		<? ;}
		else
		{
		?>
