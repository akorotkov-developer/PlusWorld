...
foreach($arResult as $arPost)
{
	...
	<?if($arParams["SEO_USER"] == "Y"):?>
		<noindex>
		<a style="background-image: url(http://www.retail-loyalty.org/bitrix/templates/.default/components/bitrix/blog.new_posts/blogosfera-rl-news/images/user.gif);
		width: 16px;
    height: 16px;
    display: block;
    float: left;
	...
	<?else:?>
		<a style="background-image: url(/bitrix/templates/.default/components/bitrix/blog.new_posts/blogosfera-rl-news/images/user.gif);
		width: 16px;
    height: 16px;
    display: block;
    float: left;
	...
	?>
        <span style="display: block; font-size: 12px; font-family: Arial,helvetica,sans-serif;  text-align: left">
			<a style="color: #A51340; font-weight: bold"
