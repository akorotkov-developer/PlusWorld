...
foreach($arResult as $arPost)
{
    if ($i<=2) {
        ...
        $arPost["urlToAuthor"] = "http://www.retail-loyalty.org/blogs/?page=user&user_id=".$arPost["AUTHOR_ID"];
        $arPost["~urlToAuthor"] = "http://www.retail-loyalty.org/blogs/?page=user&user_id=".$arPost["AUTHOR_ID"];

        $arPost["urlToBlog"] = "http://www.retail-loyalty.org/blogs/?page=blog&blog=".$arBlogUrl;
        $arPost["~urlToBlog"] = "http://www.retail-loyalty.org/blogs/?page=blog&blog=".$arBlogUrl;

        $arPost["urlToPost"] = "http://www.retail-loyalty.org/blogs/?page=post&blog=".$arBlogUrl."&post_id=".$arPost["CODE"];
        $arPost["~urlToPost"] = "http://www.retail-loyalty.org/blogs/?page=post&blog=".$arBlogUrl."&post_id=".$arPost["CODE"];
