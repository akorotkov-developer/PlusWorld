...
<item>
	...
	echo $l;
	?></description>
<?if ($arItem['ELEMENT']['DETAIL_PICTURE']):?>
<enclosure url="<?=$arItem["ELEMENT"]["DETAIL_PICTURE"]?>" 
length="<?=filesize(str_replace("http://www.plusworld.ru",$_SERVER['DOCUMENT_ROOT'], $arItem["ELEMENT"]["DETAIL_PICTURE"]))?>" 
type="image/jpeg"/>
