...
<div class="news-head">
	<a href="javascript://" onclick="atoprint('MessForPrint');"><?=GetMessage("PAGE_PRINT");?></a> &nbsp;
		<a id="iframe" href="/share.php?link=<?=SITE_SERVER_NAME.$arResult['DETAIL_PAGE_URL']?>&title=<?=str_replace('&','_ampersant',$arResult['NAME'])?>&preview=<?=str_replace('&','_ampersant',$arResult['PREVIEW_TEXT'])?>"><?=GetMessage("SEND_FRIEND");?></a>
</div>
...
<div> <?//$GLOBALS["popphotoFilter"] = array(">SHOW_COUNTER_START" => date("d-m-Y H:i:s",time()-86400*90));
	...
	"SECTION_SORT_FIELD" => "",
	"SECTION_SORT_ORDER" => "desc",
	"ELEMENT_SORT_FIELD" => "PROPERTY_POP",
	"ELEMENT_SORT_ORDER" => "desc",
