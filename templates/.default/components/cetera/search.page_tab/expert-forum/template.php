...
<?if (isset($_REQUEST["where"]) && $_REQUEST["where"] != 'expert') {} else { ?>
    <dt <?=(isset($_REQUEST["where"]) && $_REQUEST["where"] == 'expert' ? 'class="selected" style="font-weight: bold"': 'style="font-weight: bold"')?>>Форум-экспертов (<?if ($arResult["NAV_RESULT"]) echo $arResult["NAV_RESULT"]->SelectedRowsCount(); else echo 0?>)</dt>
    <dd <?=(isset($_REQUEST["where"]) && $_REQUEST["where"] == 'expert' ? 'class="selected"': '')?>>
