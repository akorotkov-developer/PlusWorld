...
<ul style="list-style: disc;">
    ...
    <li>
        <div><?=$arResult["QUESTIONS"]["QUESTIONNAIRE_14"]["CAPTION"];?><?if ($arResult["QUESTIONS"]["QUESTIONNAIRE_14"]["REQUIRED"] == "Y"){echo $arResult["REQUIRED_SIGN"];}?> </div>
        <?=$arResult["QUESTIONS"]["QUESTIONNAIRE_14"]["HTML_CODE"];?>
    </li>
    <li>
        <div><?=$arResult["QUESTIONS"]["QUESTIONNAIRE_15"]["CAPTION"];?><?if ($arResult["QUESTIONS"]["QUESTIONNAIRE_15"]["REQUIRED"] == "Y"){echo $arResult["REQUIRED_SIGN"];}?> </div>
    ...
    <p>
        November 14-15, 2018  the 10th International PLUS-Forum “Cash Circulation + Self-service. Banking and Retail 2018” will take place in Moscow. The registration is already open. See more details at plus-forum.com
    </p>
