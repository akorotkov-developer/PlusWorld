...
<li>
    <?=$arResult["QUESTIONS"]["QUESTIONNAIRE_9_11"]["CAPTION"];?>
    <?if ($arResult["QUESTIONS"]["QUESTIONNAIRE_9_11"]["REQUIRED"] == "Y"){echo $arResult["REQUIRED_SIGN"];}?> <br />
    <?=$arResult["QUESTIONS"]["QUESTIONNAIRE_9_11"]["HTML_CODE"];?>
</li>


<li><b>Оцените перечисленные ниже показатели уровня организации ПЛАС-Форума:</b></li>
    <li>
        <?=$arResult["QUESTIONS"]["QUESTIONNAIRE_9_12"]["CAPTION"];?>
        <?if ($arResult["QUESTIONS"]["QUESTIONNAIRE_9_12"]["REQUIRED"] == "Y"){echo $arResult["REQUIRED_SIGN"];}?> <br />
        <?=$arResult["QUESTIONS"]["QUESTIONNAIRE_9_12"]["HTML_CODE"];?>
    </li>
