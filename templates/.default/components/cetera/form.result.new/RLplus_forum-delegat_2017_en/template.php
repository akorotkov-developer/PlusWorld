...
<ul style="list-style: disc;">
    ...
    <li>
        <div><?=$arResult["QUESTIONS"]["QUESTIONNAIRE_111"]["CAPTION"];?></div>
        <?=$arResult["QUESTIONS"]["QUESTIONNAIRE_111"]["HTML_CODE"];?>
    </li>
	<li>
    ...
    <li>
        <div><?=$arResult["QUESTIONS"]["QUESTIONNAIRE_112"]["CAPTION"];?></div>
        <?=$arResult["QUESTIONS"]["QUESTIONNAIRE_112"]["HTML_CODE"];?>
    </li>
	<li>
    ...
    <li>
        <div><?=$arResult["QUESTIONS"]["QUESTIONNAIRE_18"]["CAPTION"];?><?if ($arResult["QUESTIONS"]["QUESTIONNAIRE_2"]["REQUIRED"] == "Y"){echo $arResult["REQUIRED_SIGN"];}?></div>
        <?=$arResult["QUESTIONS"]["QUESTIONNAIRE_18"]["HTML_CODE"];?>
    </li>
    <li>
        <div><?=$arResult["QUESTIONS"]["QUESTIONNAIRE_19"]["CAPTION"];?><?if ($arResult["QUESTIONS"]["QUESTIONNAIRE_2"]["REQUIRED"] == "Y"){echo $arResult["REQUIRED_SIGN"];}?></div>
