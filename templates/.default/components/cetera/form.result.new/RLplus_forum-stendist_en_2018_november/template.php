...
<?/*<li>
    <?=$arResult["QUESTIONS"]["QUESTIONNAIRE_9_1_2"]["CAPTION"];?>
    <?if ($arResult["QUESTIONS"]["QUESTIONNAIRE_9_1_2"]["REQUIRED"] == "Y"){echo $arResult["REQUIRED_SIGN"];}?> <br />
    <?=$arResult["QUESTIONS"]["QUESTIONNAIRE_9_1_2"]["HTML_CODE"];?>
</li>*/?>
<li><b>The target audience of the most interest to your company:</b></li>
<li>
...
<li>
    <?=$arResult["QUESTIONS"]["QUESTIONNAIRE_9_21"]["CAPTION"];?>
    <?if ($arResult["QUESTIONS"]["QUESTIONNAIRE_9_21"]["REQUIRED"] == "Y"){echo $arResult["REQUIRED_SIGN"];}?> <br />
    <?=$arResult["QUESTIONS"]["QUESTIONNAIRE_9_21"]["HTML_CODE"];?>
</li>


<li><b>Evaluate the following characteristics of the Plus-Forum organization:</b></li>

    <li>
        <?=$arResult["QUESTIONS"]["QUESTIONNAIRE_9_22"]["CAPTION"];?>
        <?if ($arResult["QUESTIONS"]["QUESTIONNAIRE_9_22"]["REQUIRED"] == "Y"){echo $arResult["REQUIRED_SIGN"];}?> <br />
        <?=$arResult["QUESTIONS"]["QUESTIONNAIRE_9_22"]["HTML_CODE"];?>
    </li>

<li><b>The PLUS-Forum Steering Committee Performance Indicators</b></li>
<li>
...
<li>
    <?=$arResult["QUESTIONS"]["QUESTIONNAIRE_99_2"]["CAPTION"];?>
    <?if ($arResult["QUESTIONS"]["QUESTIONNAIRE_99_2"]["REQUIRED"] == "Y"){echo $arResult["REQUIRED_SIGN"];}?> <br />
    <?=$arResult["QUESTIONS"]["QUESTIONNAIRE_99_2"]["HTML_CODE"];?>
</li>


<li><b>Work of the Developer</b></li>
<li>
...
<?=$arResult["QUESTIONS"]["QUESTIONNAIRE_9_8"]["HTML_CODE"];?>
    ...
    <li>
        ...
        <?if ($arResult["QUESTIONS"]["QUESTIONNAIRE_10"]["REQUIRED"] == "Y"){echo $arResult["REQUIRED_SIGN"];}?> <br />
...
<li><b>We thank you for your time to participate in the survey and hope for further cooperation.</b></li>
